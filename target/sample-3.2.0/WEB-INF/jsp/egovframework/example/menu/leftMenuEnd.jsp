<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
			...
			<div class="col-xs-3 col-sm-2 col-sm-pull-9 sidebar-offcanvas"
				...
				<div class="list-group">
					<ul class="list-group">
						<a href="officeSecurityChoice.do" class="list-group-item">사무실 보안점검 작성</a>
						<a href="watchKeepingForm.do" class="list-group-item">당직 근무일지 작성</a>
						<a href="listOfficeSecurity.do?page=1" class="list-group-item">보안 점검 조회</a>
						<a href="listWatchKeeping.do?page=1" class="list-group-item">당직 근무일지 조회</a>
