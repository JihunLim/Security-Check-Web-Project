				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<label class="control-label col-sm-2"><input type="radio"
							...
							class="control-label col-sm-2"><input type="radio"
							name="os_document" value="2">양호</label><br /> <br />
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-10">
						<label class="control-label col-sm-2"><input type="radio"
							...
							class="control-label col-sm-2"><input type="radio"
							name="os_clean" value="2">양호</label><br /> <br />
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-10">
						<label class="control-label col-sm-2"><input type="radio"
							...
							class="control-label col-sm-2"><input type="radio"
							name="os_lightout" value="2">양호</label><br /> <br />
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-10">
						<label class="control-label col-sm-2"><input type="radio"
							...
							class="control-label col-sm-2"><input type="radio"
							name="os_ventilation" value="2">양호</label><br /> <br />
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-10">
						<label class="control-label col-sm-2"><input type="radio"
							...
							class="control-label col-sm-2"><input type="radio"
							name="os_door" value="2">양호</label><br /> <br />
					</div>
				</div>
				<div class="form-group">
